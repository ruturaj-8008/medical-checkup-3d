...
export const MedicalCanvas: React.FC<MedicalCanvasProps> = ({
  ...
  return (
    <div 
      ...
      role="region"
      aria-label="Interactive holographic DNA model"
    >
      {/* ThreeJS Canvas */}
      ...
      <p className="sr-only">Use Tab to move between diagnostic nodes and Enter or Space to select a node. Nodes are unavailable while a diagnostic scan is running.</p>
    </div>
  );
};
