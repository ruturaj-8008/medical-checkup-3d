      ...
      {!isScanning ? (
        ...
        <div className="flex flex-col flex-1 gap-4 justify-between">
          <div className="flex flex-col gap-4">
            ...
            <div className="glass-panel p-4 flex items-center gap-3 border-l-4 border-cyan bg-cyan/5" role="status">
        ...
        <div className="flex flex-col flex-1 gap-4 justify-between">
          <div className="flex flex-col gap-3">
            ...
            <div className="glass-panel p-4 flex flex-col gap-3 pulsing-hud-cyan bg-black/35 relative overflow-hidden" role="status" aria-live="polite">
              <div className="scan-line" />
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-2">
                  <Scan size={18} className="text-cyan animate-spin" aria-hidden="true" />
